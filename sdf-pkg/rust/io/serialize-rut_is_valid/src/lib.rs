...
mod serialize {
    ...
    use crate::bindings::exports::estebanborai::serialize_rut_is_valid::serialize::Guest as SerializeOutputInterface;
    impl SerializeOutputInterface for Component {
        ...
        fn serialize_output(output: bool) -> Result<Vec<u8>, String> {
    ...
    fn serialize_output_impl(output: bool) -> Result<Vec<u8>, String> {
